...
<template>
  ...
  <h1>[파판14] 에오르제아어 변환기 </h1>  
  
  <h2>이 사이트에 대하여</h2>
  <hr>
      <div class="font-ref">
        <ul>
          <li> 입력한 문장을 에오르제아 공용어 폰트로 표시하여 주는 사이트 입니다.  </li>
  ...
  <div class="contextDiv">
    <div class="context">
      <textarea  style="width: 400px; height: 100px;" v-model="text" rows="4" cols="50" placeholder="텍스트를 입력하세요" @input="drawText"></textarea>
    </div>
  </div>
    ...
    <div  class="context">
      <p>
        <span>
          ...
          <select id="textFont" v-model="textFont" @change="drawText">
            ...
            <option value="EorzeanCalligraphy-Regular">EorzeanCalligraphy-Regular</option>
            <option value="EorzeanGraphite">EorzeanGraphite</option>
            <option value="EorzeanPen-Regular"> EorzeanPen-Regular</option>
            <option value="EorzeanScratch-Regular"> EorzeanScratch-Regular</option>
            <option value="EorzeanGraphite"> EorzeanGraphite</option>
          </select>
        </span>
        <span>
        ...
        <span>
          <label >글자 크기 : </label>
          <input type="number"   size = "3" maxlength='3' v-model="textSize" @input="drawText"  style="width:50px;" > px 
        </span>
      ...
      <p>
        ...
        <span>
          ...
          <input type="number" min= 0  style="width:50px;" v-model="textAxisX" @change="drawText" > px
        </span> 
        <span>
          <label for="textAxisY">글자 세로 위치 : </label>
          <input type="number" min= 0  style="width:50px;" v-model="textAxisY" @change="drawText" > px
        </span>
      </p>
      <p>
          <span>
      ...
      <p>
        <span>
          <input type="checkbox"  v-model="bgColor_notNull"  @change="drawText"  > 배경색 사용
        </span>
      ...
      <p>
        <span>
          <input type="checkbox"  v-model="borderColor_notNull"  @change="drawText"  > 테두리 사용
        </span>
        <span  v-if="borderColor_notNull" style="background-color:ghostwhite;" >
          <label for="textColor"> 테두리 색상 : </label>
          <input type="color" v-model="borderColor" @change="drawText" v-if="borderColor_notNull">
        </span>
        <span  v-if="borderColor_notNull" style="background-color:ghostwhite;">
          <label >테두리 두께 : </label>
          <input type="number"  style="width:50px;" v-model="borderSize" @change="setTextAxisX"  > px 
        </span>
        <span v-if="borderColor_notNull" style="background-color:ghostwhite;">
  ...
  <div class="contextDiv">
      ...
      <div class="context">
        <button  style="padding: auto; margin: ;" @click="convertTextToImage">이미지 다운로드</button>
      </div>
  </div>
    ...
    <div class="contextDiv">
      <div class="font-ref">
        <p>
          <span >Eorzean :  </span>
          <br>
          <a href="https://ffxiv.gamerescape.com/wiki/Alphabet">https://ffxiv.gamerescape.com/wiki/Alphabet</a>
        
        </p>
        <p>
          <span > EorzeanCalligraphy / EorzeanMess / EorzeanPen / EorzeanScratch :</span>
          <br>
          <a href="https://x.com/thatskyfii/status/1561786979158839304?s=20">https://x.com/thatskyfii/status/1561786979158839304?s=20</a>
        <br>
        </p>
        <p> 
          <span > Cartahandwriting : </span>
          <br>
          <a href="https://ranofwar.tumblr.com/post/151342456961/eorzean-handwriting-fonts">https://ranofwar.tumblr.com/post/151342456961/eorzean-handwriting-fonts</a>
        </p>
        <p>
          <span > EorzeanGraphite :  </span>
          <br>
          <a href="https://megalodon.jp/2018-0121-1307-10/dachoutom.org/ffxiv/fonts.html">https://megalodon.jp/2018-0121-1307-10/dachoutom.org/ffxiv/fonts.html</a>
        </p>
      </div>
    </div>
